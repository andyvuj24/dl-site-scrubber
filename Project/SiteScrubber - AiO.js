...
const removeElementsByRegex = async (elements, regex) => {
  if (typeof elements == "string" || elements instanceof String) {
    elements = [elements];
  }
  [...elements].forEach((e) => {
...
const googleRecaptchaListener = (form) => {
  ...
  setInterval(() => {
    if (window.grecaptcha.getResponse()) form.submit();
  }, 500);
};

async function clean_scripts() {
  ...
  if (window.location.href.includes("https://dropapk.to/")) {
    (function () {
      ...
      $(document).ready(function () {
        ...
        if ($("img")[0]) {
          var clean_input = $('<div class="input-group mb-3"></div').add(
            $('<div class="input-group-prepend text-center"></div>').add(
              $(
                '<span class="input-group-text font-weight-bold">Captcha Code </span>'
              ).append($("input.captcha_code").addClass("form-control"))
            )
          );
        ...
        setTimeout(function () {
          $("div.download_box").append(
            $(
              '<div class="alert alert-warning mt-5 text-center">TO PREVENT MALICIOUS REDIRECT, <b>HOVER</b> OVER THE BUTTON FOR 2 SECONDS TO SUBMIT CLEANLY</div>'
            )
          );
        }, 8000);
      });
  ...
  if (window.location.href.includes("https://dropgalaxy.com/")) {
    (function () {
      ...
      if (document.addEventListener)
        document.addEventListener("DOMContentLoaded", clean_dropgalaxy, false);
      else if (document.attachEvent)
        document.attachEvent("onreadystatechange", clean_dropgalaxy);
      else window.onload = clean_dropgalaxy;

      // styling
      async function clean_dropgalaxy() {
        // document.querySelector("#modalpop.modalpop").remove();
        removeElements(["#modalpop.modalpop"]);
        ...
        removeElements(["footer", "div#gdpr-cookie-notice", "#warning"]);
        removeElementsByRegex("div.mt-5.text-center", /premium/gi);
        removeElementsByRegex("div.col-md-8.mt-5", /What is DropGalaxy/gi);
      ...
      $(document).ready(function () {
        ...
        $("body > div > div.row > div.col-md-4.mt-5")
        ...
        $("footer").remove();
        $(
          "body > div.container.pt-5.page.downloadPage > div > div.col-md-12.py-3"
        ).remove();
        ...
        if ($("#downloadbtn")[0]) {
          for (var i = 0; i < $("div").length; i++) {
            if ($("div")[i].style.cssText == "margin: 10px 0px;") {
              $($("div")[i]).text(
                "You have to wait for the timer to complete otherwise the server will reject your early request, sadly."
              );
          ...
          $(
            "body > section > div > div.page-wrap > form > div:nth-child(8)"
          ).remove();
          $("body > section > div > div.row").remove();
          $("body > section > div > h1").remove();

          $(
            "body > section > div > div > form > div > div > div.captcha-wrap"
          ).append(
            $(
              '<div class="alert alert-warning">TO PREVENT MALICIOUS REDIRECT, <b>HOVER</b> OVER THE BUTTON FOR 2 SECONDS TO SUBMIT CLEANLY</div>'
            )
          );
    ...
    (function () {
      ...
      function first_page() {
        if ($("#method_free")[0]) {
          ...
          $(
            "#container > div > div.col-md-12.pt20 > center > li > ol"
          ).remove();
          $("meta").remove();
          $("ins").remove();
          $("#gdpr-cookie-notice").remove();
          ...
          $(
            "#container > div > div > div:nth-child(7) > div:nth-child(1) > form > div.rightcol"
          ).css("margin", "0 0 0 0");
  ...
  if (window.location.href.includes("https://upload.ac/")) {
    (function () {
      ...
      function clean() {
        ...
        $("#addLinkBtn").remove();
        $(
          "#myDownloadForm > div.container.download.pt50.pb50 > div > div > div > div:nth-child(2)"
        ).remove();
        $("div.fmore").remove();
